...
public class Geometry
{
	 ...
	 * 
	 * @param x1
	 *            x value of first segment point
	 * @param y1
	 *            y value of first segment point
	 * @param x2
	 *            x value of second segment point
	 * @param y2
	 *            y value of second segment point
	 * @param x3
	 *            x value of point we are interested in
	 * @param y3
	 *            y value of point we are interested in
	 * @return
	 */
	public static double distancePointToSegment(final double x1,
