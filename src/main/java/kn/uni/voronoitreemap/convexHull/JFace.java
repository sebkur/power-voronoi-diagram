...
public class JFace
{
	...
	private int index; // Position in points list, important for fast update of
						// conflicts.
	...
	/**
	 * Creates the Face with a,b,c and orients with the 4th point (which is
	 * behind the facet).
	 * 
	 */
...
//		return str;
	...
	/**
	 * Links the given face f0 with the edge between v0 and v1 with the current
	 * face
	 * 
	 */
	public void link(JFace f0, JVertex v0, JVertex v1)
	{
		...
		if (twin == null)
			throw new RuntimeException(
					"Twin of Edge is NULL. Cannot Connect Edges!");
