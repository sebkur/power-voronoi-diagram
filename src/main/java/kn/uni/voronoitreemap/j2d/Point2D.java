...
public class Point2D
{
	...
	/**
	 * Computes the dot-product of the given vector with position vector of the
	 * current point
	 * 
	 * @param vector2d
	 * @return
	...
	{
		double d = 1.0D
				/ Math.sqrt(vector2d.x * vector2d.x + vector2d.y * vector2d.y);
		x = vector2d.x * d;
		y = vector2d.y * d;
	}
	...
	/**
	 * Computes the angle between the given vector and the position vector of
	 * the current point
	 * 
	 * @param vector2d
	 * @return
